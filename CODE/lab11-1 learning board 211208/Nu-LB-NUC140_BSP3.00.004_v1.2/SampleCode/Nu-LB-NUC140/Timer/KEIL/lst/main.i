...
void Init_ADC(void)
{
  ADC_Open(((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)), (0UL<<10), (3UL<<2), (1UL << 0) | (1UL << 1) | (1UL << 7));
  ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADCR |= (1ul << 0));
}

void TMR1_IRQHandler(void)
{	
	(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((14)<<2)))) = ~(*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(2))) + ((14)<<2))));
	TIMER_ClearIntFlag(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020))); 
}

void Init_Timer1(void)
{
  TIMER_Open(((TIMER_T *) ((( uint32_t)0x40000000) + 0x10020)), (1UL << 27), 5);
  ...
  while(1)
	{
		...
		u32ADCvalue = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(7)] & (0xFFFFul << 0));
    ...
    y = ((((ADC_T *) ((( uint32_t)0x40000000) + 0xE0000)))->ADDR[(1)] & (0xFFFFul << 0));
		sprintf(Text,"T = %5d", y);
	  print_Line(2, Text);
		z = (*((volatile uint32_t *)(((((( uint32_t)0x50000000) + 0x4000) + 0x0200)+(0x40*(1))) + ((0)<<2))));
	  sprintf(Text,"T = %5d", z);
	  print_Line(3, Text);
	}
}
